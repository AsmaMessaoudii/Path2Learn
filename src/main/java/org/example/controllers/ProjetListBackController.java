...
public class ProjetListBackController {
    ...
    // ==================== NAVIGATION ====================
    @FXML private void handleHome() { naviguerVers("/fxml/MainMenu.fxml", "Path2Learn - Tableau de bord"); }
    @FXML private void handleCours() { naviguerVers("/fxml/CoursView.fxml", "Path2Learn - Gestion des cours"); }
    @FXML private void handleRessources() { naviguerVers("/fxml/RessourcesView.fxml", "Path2Learn - Gestion des ressources"); }
    @FXML private void handleQuestions() { naviguerVers("/fxml/QuestionListView.fxml", "Path2Learn - Quiz"); }
    @FXML private void handleProjets() { naviguerVers("/fxml/PortfolioListViewBack.fxml", "Path2Learn - Gestion des Portfolios"); }
    ...
    private void setupActionButtons() {
        colActions.setCellFactory(col -> new TableCell<Projet, Void>() {
            ...
            private final HBox buttons = new HBox(8, deleteBtn, detailsBtn);

            {
                deleteBtn.setStyle("-fx-background-color: #f44336; -fx-text-fill: white; -fx-font-size: 12px; -fx-padding: 6 12; -fx-background-radius: 5; -fx-cursor: hand;");
                detailsBtn.setStyle("-fx-background-color: #9C27B0; -fx-text-fill: white; -fx-font-size: 12px; -fx-padding: 6 12; -fx-background-radius: 5; -fx-cursor: hand;");
