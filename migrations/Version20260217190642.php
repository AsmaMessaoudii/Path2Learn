 ...
 */
final class Version20260217190642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evaluation (id INT AUTO_INCREMENT NOT NULL, note INT NOT NULL, date_evaluation DATETIME NOT NULL, cours_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_1323A5757ECF78B0 (cours_id), INDEX IDX_1323A575A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE like_dislike (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(10) NOT NULL, created_at DATETIME NOT NULL, cours_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_ADB6A6897ECF78B0 (cours_id), INDEX IDX_ADB6A689A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE projet (id INT AUTO_INCREMENT NOT NULL, titre_projet VARCHAR(150) NOT NULL, text VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, technologies VARCHAR(255) NOT NULL, date_realisation DATE NOT NULL, lien_demo VARCHAR(255) NOT NULL, portfolio_id INT NOT NULL, INDEX IDX_50159CA9B96B5643 (portfolio_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
