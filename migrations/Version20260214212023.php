 ...
 */
final class Version20260214212023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resume_ressource ADD CONSTRAINT FK_5EE6A4FDFC6CD52A FOREIGN KEY (ressource_id) REFERENCES ressource_pedagogique (id) ON DELETE CASCADE');
    }
