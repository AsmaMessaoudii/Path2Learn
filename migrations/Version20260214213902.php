 ...
 */
final class Version20260214213902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date_event DATE NOT NULL, heure_event TIME NOT NULL, lieu VARCHAR(150) NOT NULL, type_event VARCHAR(50) NOT NULL, user_id INT DEFAULT NULL, INDEX IDX_B26681EA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE participation_event (id INT AUTO_INCREMENT NOT NULL, date_inscription DATE NOT NULL, statut VARCHAR(20) NOT NULL, evenement_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_3472872CFD02F13 (evenement_id), INDEX IDX_3472872CA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE ressource_pedagogique (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(100) NOT NULL, type VARCHAR(50) NOT NULL, url VARCHAR(255) DEFAULT NULL, file_name VARCHAR(255) DEFAULT NULL, date_ajout DATE NOT NULL, updated_at DATETIME DEFAULT NULL, cours_id INT NOT NULL, INDEX IDX_56F6BCD67ECF78B0 (cours_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE resume_ressource (id INT AUTO_INCREMENT NOT NULL, contenu_texte LONGTEXT DEFAULT NULL, resume_court LONGTEXT DEFAULT NULL, resume_detaille LONGTEXT DEFAULT NULL, mots_cles JSON DEFAULT NULL, nombre_pages INT DEFAULT NULL, duree_video INT DEFAULT NULL, langue VARCHAR(50) DEFAULT NULL, date_analyse DATETIME NOT NULL, analyse_complete TINYINT NOT NULL, ressource_id INT NOT NULL, INDEX IDX_5EE6A4FDFC6CD52A (ressource_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE resume_ressource ADD CONSTRAINT FK_5EE6A4FDFC6CD52A FOREIGN KEY (ressource_id) REFERENCES ressource_pedagogique (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resume_ressource DROP FOREIGN KEY FK_5EE6A4FDFC6CD52A');
        ...
        $this->addSql('DROP TABLE resume_ressource');
